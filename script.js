...
//   const lengthOfWorlds = world.length;
//   const totalPrice = lengthOfWorlds * pricePerWord;
//   return totalPrice;
// }
// console.log(calculateEngravingPrice("message is for you love", 10));
...
// console.log(findLongestWord("ddd dddd ddddd dddddd"));
...
//   let finishedWorldsString = "";
//   if (string.length <= 40) {
//     return console.log(string);
//   } else if (string.length > 40) {
//     for (let i = 0; i < 40; i++) {
//       finishedWorldsString += worlds[i];
//     }
//     return console.log(finishedWorldsString + "...");
//   }
// }
// formatString("Lorem ipsum dolor sit amet consectetur worldsworldsworlds");
